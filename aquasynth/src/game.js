...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Respect global sound-mute setting
    const isGloballyMuted = localStorage.getItem('shaffer-games-muted') === 'true';
    if (isGloballyMuted) {
        synth.setVolume(0);
        const volSlider = document.getElementById('slider-volume');
        const volDisplay = document.getElementById('val-volume');
